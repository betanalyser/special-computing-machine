...
In this bot you will be able to receive sport events suitable for coefficients that you are interested in! 🎲"""
...
DO_NOT_WORRY = 'No matching events found. Do not worry, the database is updated every 5 minutes. ⏰'
...
supported_sport_events_emoji = {'Football': '⚽', 'Basketball': '🏀', 'Hockey': '🏒'}
supported_sport_events = ['Football {}'.format(supported_sport_events_emoji['Football']),
